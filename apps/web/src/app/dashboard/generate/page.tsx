...
export default function GeneratePage() {
    return (
        <Suspense fallback={<div className="page-header"><h1 className="page-title">Generate Images</h1></div>}>
            <GeneratePageContent />
        </Suspense>
    );
}
    ...
    return (
        <div className="space-y-6">
            <div className="page-header">
                ...
                <p className="page-description">Create AI-generated images with your characters and styles.</p>
            </div>
                    ...
                    {isGenerating ? (
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {generatedImages.map((image) => (
                                <div key={image.id} className="glass-card overflow-hidden group relative aspect-square">
                                    <img
                                        src={image.url}
                                        alt="Generated"
                        ...
                        <div>
                            ...
                            <div className="flex gap-2">
                                {aspectRatios.map((ratio) => (
                                    ...
                                    >
                                        <div className={cn(ratio.width, ratio.height, 'border border-current rounded-sm')} />
